...
<div class="col-md-6 offset-3" style="border: 1px solid lightgrey; border-radius: 1px">
    <form method="POST" action="/companies/{{{ $company->id }}}">
        ...
        <div class="form-group">
            ...
            <input type="text" class="form-control" id="companyNameInput" placeholder="Input name here..." name="name" value="{{ $company->name }}">
        </div>
        <div class="form-group">
            <label for="companyInfoInput">Contact information:</label>
            <textarea class="form-control" id="companyInfoInput" placeholder="Input info here..." style="height: 200px" name="info">{{ $company->info }}</textarea>
        </div>
        <div class="form-group">
